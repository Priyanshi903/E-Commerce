...
public class ProductService {
	...
	public Product getProductById(String productId) throws ProductNotFoundException {
		...
		if (product != null) {
			...
			throw new ProductNotFoundException("Product with " + productId + " not present");
		}
	...
	public boolean addProduct(Product product) throws ProductAlreadyExistsException {
		...
		if (checkProduct == null) {
			...
			log.debug("Product Exists already..............");
	...
	public List<Product> searchProductByname(String productName) throws ProductNotFoundException {
		...
		if (productList.size() == 0) {
			log.debug("Product with " + productName + " not present");
			throw new ProductNotFoundException("Product with " + productName + " not present");
		} else {
	...
	public List<Product> getAllProducts() {
		...
		log.debug("All list of products:{}", productList);
		return productList;
	}
