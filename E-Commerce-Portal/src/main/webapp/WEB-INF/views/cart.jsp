			...
			<c:forEach var="cartItem" items="${cartList}">
				<div class="card" style="width: 18rem;">
					...
					<div class="card-body">
						...
						<div class="price">
							<span class="material-icons"> currency_rupee </span>${cartItem.product.product_price}</div>${cartItem.product.product_description}</br>Quantity
						${cartItem.quantity }
						<div>Delivery charges : ${cartItem.vendor.delivery_charge}</div>
						...
						<p>
							Rating : <span>${cartItem.product.product_rating}</span>
						</p>
						<form:form action="/add-rating" method="POST"
							modelAttribute="product">

							<label>Rating</label>
							<form:input path="product_id"
								value="${cartItem.product.product_id}" type="hidden" />
							<form:select path="product_rating" class="tab">
							...
							<input type="submit" value="Post rating" class="rate-btn" />
						</form:form>
						<div class="info">
							<div class="price">
							...
							<a href="/delete?id=${cartItem.product.product_id}"
